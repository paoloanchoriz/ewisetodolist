...
public class WebAppConfig extends WebMvcConfigurerAdapter {
    ...
    private static final String PROPERTY_NAME_AUTO_CREATE = "hibernate.hbm2ddl.auto";
	...
	private Properties hibProperties() {
		...
		properties.put(PROPERTY_NAME_AUTO_CREATE, env.getRequiredProperty(PROPERTY_NAME_AUTO_CREATE));
		return properties;	
	}
